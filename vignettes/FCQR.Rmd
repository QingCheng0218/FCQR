...
```{r gg-oz-gapminder,warning = FALSE, fig.cap = "\\label{testPlot}Estimated coefficient function $B^T_{rS}(s)\\hat \\gamma_{S}(0.5)$  under a censoring rate of 20%.", fig.pos="H"}
resplot6
```
...
```{r gg-oz-gapminder1,warning = FALSE, fig.cap = "\\label{testPlot}Estimated coefficient function $B^T_{rS}(s)\\hat \\gamma_{S}(0.5)$ with $d_S = 6$ under a censoring rate of 20%.", fig.pos="H"}
mimicplot;
```
...
```{r real1,warning = FALSE, fig.cap = "\\label{testPlot}Estimated coefficient function $B^T_{rS}(s)\\hat \\gamma_{S}(\\tau)$ with $d_S = 7$.", fig.pos="H"}
realplot;
```
